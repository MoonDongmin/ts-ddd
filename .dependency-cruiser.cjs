...
module.exports = {
  forbidden: [
    ...
    // =============================================================
    {
      ...
      comment: 'Application 계층은 Adapter 계층에 의존하면 안 됩니다 (DIP 원칙). Module 파일은 Composition Root 역할이므로 예외',
      severity: 'error',
      from: {
    ...
    // =============================================================
    {
      ...
      comment: 'Application 계층은 오직 Application 또는 Adapter에서만 접근 가능합니다',
      severity: 'error',
      from: {
        path: '^src/domain/',
      },
